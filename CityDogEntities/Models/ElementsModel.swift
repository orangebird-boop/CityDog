...
public struct ElementsModel {
	public init(type: String, title: String, imageURL: String, id: String, adresse: String, postalCode: String, latitude: Double, long: Double, goodToKnow: [String], description: String, phoneNumber: String, sumRating: Int, comments: Comments) {
		self.type = type
		self.title = title
