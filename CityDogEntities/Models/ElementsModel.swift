...
public struct ElementsModel: Codable, Identifiable {
    ...
    public init(id: String, name: String, type: String, address: String, description: String, goodToKnow: String, longitude: String, latitude: String, sumRating: String, comments: [Comment]) {
        self.id = id
        self.name = name
        self.type = type
